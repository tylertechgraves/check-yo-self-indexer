...
dotnet pack ./check-yo-self-indexer-sdk.csproj /p:PackageVersion=1.0.3-beta --configuration Debug --include-source --include-symbols --output ./nupkg --version-suffix "beta"
